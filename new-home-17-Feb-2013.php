...
<div id="home-news-arhive-link" class="left-links-archive-link"><a href="/alerts-and-news/">See</a></div>
<ul>    
<?php
    ...
    while ( have_posts() ) : the_post();
                ...
                <li style="display: none;"><!-- display: none; is used because the items are revealed through javascript to prevent overcrowding of the areaa -->
