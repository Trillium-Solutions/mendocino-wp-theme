...
<div id="home-news-title-text">News</div>
<div id="home-news-arhive-link"><a href="/alerts-and-news/">See all</a></div></div>
<?php $posts = query_posts( $query_string . '&cat=3&orderby=asc&posts_per_page=3' ); ?>
<?php if( $posts ) : ?>
