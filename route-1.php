...
<?php do_action('mendo_route_alert', '1'); ?>
<main>
...
<img src="/images/mapsandschedules/maps-n-schedules-circ-1.png" height="15" > <strong>Route 1 - Willits Local</strong> is a service within Willits, Monday through Friday. Note: Route 20 can also be used for local routes within Willits.
		...
		<div id="route-schedule-box" class="route-box ">
			...
			<a href="/routes/route-1/route-1-northbound/" >
				<div id="schedule-southbound-65" class="route-popup-button route-button-right route-button-last route-button-odd route-button-short" style="height:45px;">
				...
				<a href="/routes/route-1/route-1-southbound/">
        ...
        <div class="route-inner-box">
            <div id="route-pdf-icon"></div>
                <div id="route-pdf-link">
                    <a href="<?php the_field('schedule_pdf'); ?>" target="_blank">Download PDF version of Route 1 timetable.</a></div> <!-- end #route-pdf-link -->
            <br style="clear: both;" />
