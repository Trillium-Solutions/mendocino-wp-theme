...
Please see PDF for current reduced service.
        </div> <!-- end #route-desc -->
		<div id="route-schedule-box" class="route-box ">
			...
			<a href="/routes/route-60/route-60-northbound/"  >
				...
				<a href="/routes/route-60/route-60-southbound/"  >
    ...
    <div class="route-inner-box">
            <div id="route-pdf-icon"></div>
                <div id="route-pdf-link">
                    <a href="<?php the_field('schedule_pdf'); ?>" target="_blank">Download PDF version of Route 60 timetable.</a></div> <!-- end #route-pdf-link -->
            <br style="clear: both;" />
