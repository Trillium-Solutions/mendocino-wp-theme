	...
	<div id="route-connections-box" class="route-box">
		<div id="route-connections-box-title" class="route-title-box">
			...
			<div class="route-inner-box">
				<div id="route-pdf-icon"></div><div id="route-pdf-link"><a href="/files/final/MTA%20schedule%20Inland%20Route%2065.pdf">Download PDF version of Route 65 timetable.</a></div> <!-- end #route-pdf-link -->
				<br style="clear: both;" />
